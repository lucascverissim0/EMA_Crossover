...
Outputs:
- FTMO_Challenge/track_metrics_summary.txt
- FTMO_Challenge/track_metrics_summary.json
- FTMO_Challenge/Track_A_Capital_Preservation/reports/track_a_daily_activity.csv
- FTMO_Challenge/Track_B_WalkForward_Robust/reports/track_b_daily_activity.csv
"""
