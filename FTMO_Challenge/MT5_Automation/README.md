...
```bash
cp FTMO_Challenge/MT5_Automation/config.example.json FTMO_Challenge/MT5_Automation/config.json
```
...
```bash
python FTMO_Challenge/MT5_Automation/run_track_d_mt5.py --config FTMO_Challenge/MT5_Automation/config.json
```
...
```bash
python FTMO_Challenge/MT5_Automation/run_track_d_mt5.py --config FTMO_Challenge/MT5_Automation/config.json --execute
```
