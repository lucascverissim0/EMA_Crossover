...
```bash
python FTMO_Challenge/Long_Strategy/Track_A_Capital_Preservation/scripts/ftmo_validator.py
python FTMO_Challenge/Long_Strategy/Track_A_Capital_Preservation/scripts/ftmo_visualizer.py
python FTMO_Challenge/Long_Strategy/Track_A_Capital_Preservation/scripts/ftmo_optimizer.py
```
