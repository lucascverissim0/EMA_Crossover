...
```bash
python FTMO_Challenge/Track_B_WalkForward_Robust/scripts/walk_forward_ftmo.py
python FTMO_Challenge/Track_B_WalkForward_Robust/scripts/wfv_pass_probability_search.py
```
